* roadmap [0/10]
** TODO generate initial white/black board
** TODO create reputation system for each cell on the board
** TODO dynamically redraw tiles on board
** TODO create balance system(-100; +100)
** TODO create multiple random chest
** TODO choose skills system
** TODO skills
*** TODO create soul
*** TODO create statue
