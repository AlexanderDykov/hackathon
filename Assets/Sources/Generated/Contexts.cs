...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, UnityEngine.Vector2>(
            ...
            (e, c) => ((GameScene.ECS.Components.TileComponent)c).Position));

        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, GameScene.ECS.Components.TileType>(
            TileTileType,
            game.GetGroup(GameMatcher.Tile),
            (e, c) => ((GameScene.ECS.Components.TileComponent)c).TileType));
    }
}
