...
public partial class GameEntity {
    ...
    static readonly GameScene.ECS.Components.AttackableComponent attackableComponent = new GameScene.ECS.Components.AttackableComponent();

    public bool isAttackable {
        get { return HasComponent(GameComponentsLookup.Attackable); }
        set {
            if (value != isAttackable) {
                var index = GameComponentsLookup.Attackable;
                if (value) {
