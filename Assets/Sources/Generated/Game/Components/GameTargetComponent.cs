...
public partial class GameEntity {
    ...
    public GameScene.ECS.Components.TargetComponent target { get { return (GameScene.ECS.Components.TargetComponent)GetComponent(GameComponentsLookup.Target); } }
    public bool hasTarget { get { return HasComponent(GameComponentsLookup.Target); } }

    public void AddTarget(GameEntity newEntity) {
        var index = GameComponentsLookup.Target;
        var component = CreateComponent<GameScene.ECS.Components.TargetComponent>(index);
        component.Entity = newEntity;
        AddComponent(index, component);
    }

    public void ReplaceTarget(GameEntity newEntity) {
        var index = GameComponentsLookup.Target;
        var component = CreateComponent<GameScene.ECS.Components.TargetComponent>(index);
        component.Entity = newEntity;
