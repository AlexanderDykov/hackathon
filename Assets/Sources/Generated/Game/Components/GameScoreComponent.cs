...
public partial class GameContext {
    ...
    public GameScene.ECS.Components.ScoreComponent score { get { return scoreEntity.score; } }
    public bool hasScore { get { return scoreEntity != null; } }

    public GameEntity SetScore(int newValue) {
        if (hasScore) {
            throw new Entitas.EntitasException("Could not set Score!\n" + this + " already has an entity with GameScene.ECS.Components.ScoreComponent!",
...
public partial class GameEntity {
    ...
    public GameScene.ECS.Components.ScoreComponent score { get { return (GameScene.ECS.Components.ScoreComponent)GetComponent(GameComponentsLookup.Score); } }
    ...
    public void AddScore(int newValue) {
        ...
        var component = CreateComponent<GameScene.ECS.Components.ScoreComponent>(index);
